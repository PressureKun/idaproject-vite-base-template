...
export const formatDateTime = (date, pattern) => {
    ...
    const params = {
        ...
        // Days of the week
        $D: new Intl.DateTimeFormat('ru-RU', { weekday: 'short' }).format(d), // Day of the week, textual, 3 letters. // 'Пн', 'Вт'
        $l: new Intl.DateTimeFormat('ru-RU', { weekday: 'long' }).format(d), // Day of the week, textual, long. // 'Пятница'
